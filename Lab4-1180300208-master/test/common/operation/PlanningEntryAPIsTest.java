...
public class PlanningEntryAPIsTest {
	...
	/*
	 *  testing strategy：
	 *  	对CourseEntry的各种情况的PlanningEntryAPIs中的checkLocationConflict、checkResourceExclusive、findPreEntryPerResource方法进行测试。
	 */
	@Test
	...
	/*
	 *  testing strategy：
	 *  	对FlightEntry的各种情况的PlanningEntryAPIs中的checkLocationConflict、checkResourceExclusive、findPreEntryPerResource方法进行测试。
	 */
	@Test
	...
	/*
	 *  testing strategy：
	 *  	对TrainEntry的各种情况的PlanningEntryAPIs中的checkLocationConflict、checkResourceExclusive、findPreEntryPerResource方法进行测试。
	 */
	@Test
